...
const blogFeatures = [
  {
    ...
    description: "Deep dives into emerging tech trends and industry strategies.",
  ...
  },
  {
    ...
    description: "Expert perspectives on scaling modern software ecosystems.",
  ...
  },
  {
    ...
    description: "Real-world experiences, case studies, and engineering updates.",
    iconClass: "text-blue-400",
    bgClass: "bg-blue-500/10 border-blue-500/20",
  },
];

export default function SimpleBlogHero() {
  return (
      ...
      <div className="relative z-20 mx-auto max-w-[1445px] px-4 sm:px-6 lg:px-10">
        ...
        <div className="mx-auto max-w-[950px] text-center">
          ...
          <p className="mx-auto mt-5 max-w-[720px] text-[16px] sm:text-[18px] lg:text-[20px] leading-[1.6] sm:leading-[1.7] text-white">
            Stay ahead with the latest announcements, engineering breakthroughs, and thought leadership from our team and technology community.
          </p>
